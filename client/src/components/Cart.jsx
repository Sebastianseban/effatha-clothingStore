...
const Cart = ({ isOpen, onClose, cartItems = [] }) => {
  ...
  return (
    <div className="fixed right-0 top-0 h-full w-[350px] bg-white shadow-lg z-50 flex flex-col">
    {/* Header */}
    ...
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      <div className="flex items-center gap-4">
        <img src="/card2.png" alt="item" className="w-16 h-16 object-cover rounded" />
      ...
      <div className="flex items-center gap-4">
        <img src="/tshirt.png" alt="item" className="w-16 h-16 object-cover rounded" />
        <div className="flex-1">
